...
Comment the properties inside the config using OSGi metadata capabilities
...
* create a new bnd test project with testdata and create OSGi test for mirroring a file and http based repo
* create testcase for spawning and mirroring multiple repos simultaneously
